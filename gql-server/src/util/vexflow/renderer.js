...
class Renderer {
  ...
  static bolsterCanvasContext(ctx) {
    ...
    const methodNames = ['clear', 'setFont', 'setRawFont', 'setFillStyle', 'setBackgroundFillStyle', 'setStrokeStyle', 'setShadowColor', 'setShadowBlur', 'setLineWidth', 'setLineCap', 'setLineDash', 'openGroup', 'closeGroup', 'getGroup'];
  ...
  resize(width, height) {
    if (this.backend === Renderer.Backends.CANVAS) {
      ...
      [width, height] = _canvascontext.CanvasContext.SanitizeCanvasDims(width, height);
