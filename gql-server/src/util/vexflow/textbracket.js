...
class TextBracket extends _element.Element {
  ...
  draw() {
    ...
    if (this.render_options.dashed) {
      // Main line
      _renderer.Renderer.drawDashedLine(ctx, start_x, line_y, end_x, line_y, this.render_options.dash); // Ending Bracket
...
//# sourceMappingURL=textbracket.js.map