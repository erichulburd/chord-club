...
class Element {
  ...
  constructor({
    ...
    this.context = null;
    this.rendered = false;
    this.fontStack = _tables.Flow.DEFAULT_FONT_STACK;
    this.musicFont = _tables.Flow.DEFAULT_FONT_STACK[0]; // If a default registry exist, then register with it right away.
