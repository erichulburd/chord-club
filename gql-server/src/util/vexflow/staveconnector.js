...
class StaveConnector extends _element.Element {
  ...
  constructor(top_stave, bottom_stave) {
    ...
    this.thickness = _tables.Flow.STAVE_LINE_THICKNESS;
    this.width = 3;
  ...
  draw() {
    ...
    switch (this.type) {
      ...
      case StaveConnector.type.BRACKET:
        ...
        _glyph.Glyph.renderGlyph(ctx, topX - 5, topY, 40, 'bracketTop');

        _glyph.Glyph.renderGlyph(ctx, topX - 5, botY, 40, 'bracketBottom');
...
//# sourceMappingURL=staveconnector.js.map