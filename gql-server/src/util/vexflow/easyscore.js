...
const X = exports.X = _vex.Vex.MakeException('EasyScoreError');
...
class Builder {
  ...
  commitPiece() {
    ...
    const stemDirection = !autoStem && stem.toLowerCase() === 'up' ? _stavenote.StaveNote.STEM_UP : _stavenote.StaveNote.STEM_DOWN; // Build StaveNotes.
...
//# sourceMappingURL=easyscore.js.map