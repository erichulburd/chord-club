...
class Repetition extends _stavemodifier.StaveModifier {
  static get CATEGORY() {
    return 'repetitions';
  }
  ...
  drawCodaFixed(stave, x) {
    ...
    _glyph.Glyph.renderGlyph(stave.context, this.x + x + this.x_shift, y + 25, 40, 'coda', {
      category: 'coda'
    });
  ...
  drawSignoFixed(stave, x) {
    ...
    _glyph.Glyph.renderGlyph(stave.context, this.x + x + this.x_shift, y + 25, 30, 'segno', {
      category: 'segno'
    });
  ...
  drawSymbolText(stave, x, text, draw_coda) {
    ...
    if (draw_coda) {
      _glyph.Glyph.renderGlyph(ctx, symbol_x, y, 40, 'coda', {
        category: 'coda'
      });
    }
...
//# sourceMappingURL=staverepetition.js.map