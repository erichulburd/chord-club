...
/** @constructor */
class ClefNote extends _note.Note {
  static get CATEGORY() {
    return 'clefnote';
  }
  ...
  draw() {
    ...
    if (this.clef_obj.annotation !== undefined) {
      const attachment = new _glyph.Glyph(this.clef_obj.annotation.code, this.clef_obj.annotation.point);
...
//# sourceMappingURL=clefnote.js.map