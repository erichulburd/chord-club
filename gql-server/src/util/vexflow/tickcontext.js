...
// tabs, etc.
class TickContext extends _tickable.Tickable {
  ...
  constructor(options) {
    ...
    this.currentTick = new _fraction.Fraction(0, 1);
    this.maxTicks = new _fraction.Fraction(0, 1);
...
//# sourceMappingURL=tickcontext.js.map