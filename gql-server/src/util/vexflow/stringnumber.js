...
class StringNumber extends _modifier.Modifier {
  static get CATEGORY() {
    return 'stringnumber';
  } // ## Static Methods
  ...
  constructor(number) {
    ...
    this.position = _modifier.Modifier.Position.ABOVE; // Default position above stem or note head
    ...
    this.leg = _renderer.Renderer.LineEndType.NONE; // draw upward/downward leg at the of extension line
