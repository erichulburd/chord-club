...
class Vibrato extends _modifier.Modifier {
  static get CATEGORY() {
    return 'vibratos';
  } // ## Static Methods
  ...
  static format(vibratos, state, context) {
    ...
    const bends = context.getModifiers(_bend.Bend.CATEGORY);
  ...
  constructor() {
    ...
    this.position = _modifier.Modifier.Position.RIGHT;
    this.render_options = {
      harsh: false,
      vibrato_width: 20,
      wave_height: 6,
  ...
  draw() {
    ...
    this.setRendered();
    const start = this.note.getModifierStartXY(_modifier.Modifier.Position.RIGHT, this.index);
