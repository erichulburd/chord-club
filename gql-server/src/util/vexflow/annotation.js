...
class Annotation extends _modifier.Modifier {
  static get CATEGORY() {
    return 'annotations';
  ...
  constructor(text) {
    ...
    this.setWidth(_tables.Flow.textWidth(text));
  }
  ...
  draw() {
    ...
    this.setRendered();
    const start = this.note.getModifierStartXY(_modifier.Modifier.Position.ABOVE, this.index); // We're changing context parameters. Save current state.
