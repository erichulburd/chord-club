...
class StaveText extends _stavemodifier.StaveModifier {
  static get CATEGORY() {
    return 'stavetext';
  }
  ...
  draw(stave) {
    ...
    let x;
    let y;
    const Position = _stavemodifier.StaveModifier.Position;
    const Justification = _textnote.TextNote.Justification;
...
//# sourceMappingURL=stavetext.js.map