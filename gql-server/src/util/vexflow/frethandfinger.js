 ...
 * @constructor
 */
class FretHandFinger extends _modifier.Modifier {
  static get CATEGORY() {
  ...
  static format(nums, state) {
    ...
    for (let i = 0; i < nums_list.length; ++i) {
      ...
      const {
        ...
        shiftL,
        shiftR
      } = nums_list[i]; // Reset the position of the string number every line.
  ...
  constructor(number) {
    ...
    this.finger = number;
    this.width = 7;
    this.position = _modifier.Modifier.Position.LEFT; // Default position above stem or note head
...
//# sourceMappingURL=frethandfinger.js.map