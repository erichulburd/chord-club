...
class TextNote extends _note.Note {
  ...
  constructor(options) {
    ...
    if (options.glyph) {
      ...
      if (!struct) throw new _vex.Vex.RERR('Invalid glyph type: ' + options.glyph);
      this.glyph = new _glyph.Glyph(struct.code, 40, {
        category: 'textNote'
      });
...
//# sourceMappingURL=textnote.js.map